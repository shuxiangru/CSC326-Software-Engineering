...
<div class="panel panel-default">
	...
	<div class="panel-body" id="orth-menu">
		<ul class="nav nav-sidebar">
			<li><a href="/iTrust/auth/hcp/selectOrthopedicVisit.jsp">Orthopedic Visits</a></li>
			<li><a href="/iTrust/auth/hcp/selectSurgicalOrthopedicVisit.jsp">Surgical Orthopedic Visits</a></li>
		</ul>
...
<div class="panel panel-default">
	...
	<div class="panel-body" id="phys-menu">
		<ul class="nav nav-sidebar">
			<li><a href="/iTrust/auth/hcp/selectPhysicalTherapyVisit.jsp">Physical Therapy Visits</a></li>
		</ul>
	</div>
</div>
