...
public class DAOFactory {
	...
	public OrthopedicVisitDAO getOrthopedicVisitDAO() {
		return new OrthopedicVisitDAO(this);
	}

	public PhysicalTherapyVisitDAO getPhysicalTherapyVisitDAO() {
		return new PhysicalTherapyVisitDAO(this);
	}

	public SurgicalOrthopedicVisitDAO getSurgicalOrthopedicVisitDAO() {
		return new SurgicalOrthopedicVisitDAO(this);
	}
}
