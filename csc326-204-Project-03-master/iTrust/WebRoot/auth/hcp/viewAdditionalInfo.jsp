...
if("date".equals(request.getParameter("sortByA"))) {
...
<input type="hidden" name="sortByA" value="date"></input>
<div align=center>
<table class="fTable" align="center">
	<tr class="subHeader">
		<td>Start Date:</td>
...
<br />
<input type="submit" name="submitRecord" value="Get Records" onclick="javascript:sortBy();">
</div>
</form>
<%
}
...
function sortBy() {
	document.getElementsByName('sortByA')[0].value = "date";
