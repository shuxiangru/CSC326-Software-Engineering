...
public class ReferralDAO {
	...
	public List<ReferralBean> getReferralsFromOV(long ovid) throws DBException {
		try(
				...
				PreparedStatement ps = conn.prepareStatement("SELECT * FROM referrals WHERE ovID = ?");
			) {
	...
	public List<ReferralBean> getReferralsSentFrom(long mid) throws DBException {
		try (
				Connection conn = factory.getConnection();
				PreparedStatement ps = conn.prepareStatement("SELECT * FROM referrals WHERE SenderID = ?");
			){
	...
	public ReferralBean getReferral(long id) throws DBException {
		try (
				Connection conn = factory.getConnection();
				PreparedStatement ps = conn.prepareStatement("SELECT * FROM referrals WHERE id = ?");
				) {
			ps.setLong(1, id);
			ResultSet rs = ps.executeQuery();
			if(rs.next()){
	...
	public boolean setReferralMessage(long messageID, long referralID) throws DBException {
		try (
				Connection conn = factory.getConnection();
				PreparedStatement ps = conn.prepareStatement("INSERT INTO referralmessage (messageID,referralID) VALUES (?,?) ");	
			){
	...
	public long isReferralMessage(long messageID) throws DBException {
		try (Connection conn = factory.getConnection();
				PreparedStatement ps = conn.prepareStatement("SELECT * FROM referralmessage WHERE messageID = ?");
				){
	...
	public List<ReferralBean> getReferralsSentTo(long mid) throws DBException {
		try ( Connection conn = factory.getConnection();
				PreparedStatement ps = conn.prepareStatement("SELECT * FROM referrals WHERE ReceiverID = ?");
				){
	...
	public List<ReferralBean> getReferralsForReceivingHCP(long mid) throws DBException {
		try (
				Connection conn = factory.getConnection();
				PreparedStatement ps = conn.prepareStatement("SELECT * FROM referrals WHERE ReceiverID = ? ORDER BY PriorityCode ASC");
			) {
	...
	public List<ReferralBean> getReferralsForPatient(long mid) throws DBException {
		try (
				Connection conn = factory.getConnection();
				PreparedStatement ps = conn.prepareStatement("SELECT * FROM referrals WHERE PatientID = ? ORDER BY viewed_by_patient, PriorityCode ASC");
	...
	public List<ReferralBean> getReferralsForReceivingHCPUnread(long mid) throws DBException {
		try (Connection conn = factory.getConnection();
				PreparedStatement ps = conn.prepareStatement("SELECT * FROM referrals WHERE ReceiverID = ? AND viewed_by_HCP = false");){
	...
	public List<ReferralBean> getReferralsForPatientUnread(long mid) throws DBException {
		try (
				Connection conn = factory.getConnection();
				PreparedStatement ps = conn.prepareStatement("SELECT * FROM referrals WHERE PatientID = ? AND viewed_by_patient = false");
				){
	...
	public void editReferral(ReferralBean r) throws DBException {
		try (
				Connection conn = factory.getConnection();
				PreparedStatement ps = conn.prepareStatement("UPDATE referrals SET PatientID=?,SenderID=?,ReceiverID=?,"
	...
	public long addReferral(ReferralBean r) throws DBException {
		try(Connection conn = factory.getConnection();
				PreparedStatement ps = conn.prepareStatement("INSERT INTO referrals (PatientID,SenderID,ReceiverID,"
	...
	public void removeReferral(long id) throws DBException {
		try (Connection conn = factory.getConnection();
				PreparedStatement ps = conn.prepareStatement("DELETE FROM referrals WHERE ID=? ");){
