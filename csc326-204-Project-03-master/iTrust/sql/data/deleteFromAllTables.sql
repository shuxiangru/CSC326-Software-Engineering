...
DELETE FROM orthopedicvisits;
ALTER TABLE orthopedicvisits AUTO_INCREMENT = 0;

DELETE FROM physicaltherapyvisits;
ALTER TABLE physicaltherapyvisits AUTO_INCREMENT = 0;

DELETE FROM surgicalorthopedicvisits;
ALTER TABLE surgicalorthopedicvisits AUTO_INCREMENT = 0;
