...
public class LabProcedureDAO {
	...
	public List<LabProcedureBean> getLabProceduresForPatient(long id) throws DBException {
		...
		try (Connection conn = factory.getConnection();
				PreparedStatement ps = conn.prepareStatement("SELECT * FROM labprocedure WHERE PatientMID = ? AND Rights = ? ORDER BY UpdatedDate DESC");
				)
	...
	public List<LabProcedureBean> getLabProceduresForPatientOV(long ovid) throws DBException {
		...
		try (Connection conn = factory.getConnection();
				...
				PreparedStatement ps = conn.prepareStatement("SELECT * FROM labprocedure WHERE OfficeVisitID = ? AND Rights = ? ORDER BY UpdatedDate DESC");
			)
		{
			ps.setLong(1, ovid);
			ps.setString(2, LabProcedureBean.Allow);
	...
	public List<LabProcedureBean> getLabProceduresForPatientForNextMonth(long id) throws DBException {
		...
		try (Connection conn = factory.getConnection();
				...
				PreparedStatement ps = conn.prepareStatement("SELECT * FROM labprocedure WHERE PatientMID = ? AND Rights = ? AND Status = ? AND (DateDiff(SYSDATE(),UpdatedDate) <= 30) ORDER BY UpdatedDate DESC");
			)
		{
			if (id == 0L) throw new SQLException("PatientMID cannot be null");
			ps.setLong(1, id);
	...
	public LabProcedureBean getLabProcedure(long id) throws DBException {
		...
		try (Connection conn = factory.getConnection();
				...
				PreparedStatement ps = conn.prepareStatement("SELECT * FROM labprocedure WHERE LaboratoryProcedureID = ?");
			)
		{
			ps.setLong(1, id);
			ResultSet rs = ps.executeQuery();
	...
	public List<LabProcedureBean> getAllLabProceduresDate(long mid) throws DBException {
		...
		try (Connection conn = factory.getConnection();
				...
				PreparedStatement ps = conn.prepareStatement("SELECT * FROM labprocedure WHERE PatientMID = ? ORDER BY UpdatedDate DESC");
			)
		{
	...
	public List<LabProcedureBean> getAllLabProceduresForDocOV(long mid, long ovid) throws DBException {
		...
		try (Connection conn = factory.getConnection();
				...
				PreparedStatement ps = conn.prepareStatement("SELECT * FROM labprocedure WHERE PatientMID = ? AND OfficeVisitID = ? ORDER BY UpdatedDate DESC");
			)
		{
			if (mid == 0L) throw new SQLException("PatientMID cannot be null");			
			ps.setLong(1, mid);
	...
	public List<LabProcedureBean> getAllLabProceduresForDocOV(long ovid) throws DBException {
		...
		try (Connection conn = factory.getConnection();
			...
			PreparedStatement ps = conn.prepareStatement("SELECT * FROM labprocedure WHERE OfficeVisitID = ? ");
			)
		{
			ps.setLong(1, ovid);
			ResultSet rs = ps.executeQuery();
	...
	public List<LabProcedureBean> getAllLabProcedures() throws DBException {
		...
		try (Connection conn = factory.getConnection();
				...
				PreparedStatement ps = conn.prepareStatement("SELECT * FROM labprocedure ORDER BY UpdatedDate ASC");
			)
		{
			ResultSet rs = ps.executeQuery();
			List<LabProcedureBean> loadlist = labProcedureLoader.loadList(rs);
	...
	public List<LabProcedureBean> getLabProceduresForLHCPForNextMonth(long ovid) throws DBException {
		...
		try (Connection conn = factory.getConnection();
				PreparedStatement ps = conn.prepareStatement("SELECT * FROM labprocedure WHERE OfficeVisitID = ? AND Status = ? AND (DateDiff(SYSDATE(),UpdatedDate) <= 30) ORDER BY UpdatedDate DESC");
			)
		{
	...
	public void updateLabProcedure(LabProcedureBean b) throws DBException {
		...
		try(Connection conn = factory.getConnection();
				PreparedStatement ps = conn.prepareStatement("UPDATE labprocedure SET "+
	...
	public void markViewed(LabProcedureBean b) throws DBException {
		...
		try (Connection conn = factory.getConnection();
				PreparedStatement ps = conn.prepareStatement("UPDATE labprocedure SET ViewedByPatient = ? WHERE LaboratoryProcedureID=?");
			)
		{
			if (b.getPid() == 0L) throw new SQLException("PatientMID cannot be null");
	...
	public int getPatientUnviewedCount(long pid) throws DBException {
		...
		try (Connection conn = factory.getConnection();
				PreparedStatement ps = conn.prepareStatement("SELECT COUNT(*) FROM labprocedure WHERE PatientMID = ? AND Rights = ? AND Status = ? AND ViewedByPatient = FALSE ");
			)
		{
	...
	public List<LabProcedureBean> getAllLabProceduresLOINC(long id, String loinc) throws DBException {
		...
		try (Connection conn = factory.getConnection();
				PreparedStatement ps = conn.prepareStatement("SELECT * FROM labprocedure WHERE PatientMID = ? AND LaboratoryProcedureCode = ? AND Status = ?");
			)
		{
			ps.setLong(1, id);
	...
	public void updateRights(LabProcedureBean b) throws DBException {
		...
		try (Connection conn = factory.getConnection();
				PreparedStatement ps = conn.prepareStatement("UPDATE labprocedure SET Rights = ?, UpdatedDate = ? WHERE LaboratoryProcedureID=?");
			)
		{
			if (b.getPid() == 0L) throw new SQLException("PatientMID cannot be null");		
	...
	public void removeLabProcedure(long procedureID) throws DBException {
		...
		try (Connection conn = factory.getConnection();
				PreparedStatement ps = conn.prepareStatement("DELETE FROM labprocedure WHERE LaboratoryProcedureID=? ");
			)
		{
	...
	public List<LabProcedureBean> getLabProceduresInTransitForLabTech(long id) throws DBException {
		...
		try (Connection conn = factory.getConnection();
				PreparedStatement ps = conn.prepareStatement("SELECT * FROM labprocedure WHERE LabTechID = ? AND Status = ? ORDER BY UpdatedDate ASC");
			)
		{
	...
	public List<LabProcedureBean> getLabProceduresReceivedForLabTech(long id) throws DBException {
		...
		try (Connection conn = factory.getConnection();
				PreparedStatement ps = conn.prepareStatement("SELECT * FROM labprocedure WHERE LabTechID = ? AND Status = ? ORDER BY PriorityCode ASC, UpdatedDate DESC");
			)
		{
			if (id == 0L) throw new SQLException("LabTechID cannot be null");
	...
	public List<LabProcedureBean> getLabProceduresTestingForLabTech(long id) throws DBException {
		...
		try (Connection conn = factory.getConnection();
				PreparedStatement ps = conn.prepareStatement("SELECT * FROM labprocedure WHERE LabTechID = ? AND Status = ? ORDER BY UpdatedDate DESC");
			){
			if (id == 0L) throw new SQLException("LabTechID cannot be null");
			ps.setLong(1, id);
	...
	public int getLabTechQueueSize(long mid) throws DBException {
		...
		try (Connection conn = factory.getConnection();
				PreparedStatement ps = conn.prepareStatement("SELECT COUNT(*) FROM labprocedure WHERE LabTechID = ? AND (Status = ? OR Status = ?)");
			)
		{
	...
	public int[] getLabTechQueueSizeByPriority(long mid) throws DBException {
		...
		try (Connection conn = factory.getConnection();
				PreparedStatement ps = conn.prepareStatement("SELECT COUNT(*) FROM labprocedure WHERE LabTechID = ? AND (Status = ? OR Status = ?) AND PriorityCode = ?");
			)
		{
			if (mid == 0L) throw new SQLException("LabTechID cannot be null");
			for(int i=1; i<=3; i++) {
	...
	public void submitTestResults(long id, String numericalResult, String numericalResultUnit, String upper, String lower) throws DBException {	
		...
		try (Connection conn = factory.getConnection();
				PreparedStatement ps = conn.prepareStatement("UPDATE labprocedure SET NumericalResults = ?, NumericalResultsUnit = ?, UpperBound = ?, LowerBound = ?, Status = ?, UpdatedDate = ? WHERE LaboratoryProcedureID=?");
			)
		{
	...
	public void submitReceivedLP(long id) throws DBException {
		...
		try (Connection conn = factory.getConnection();
				PreparedStatement ps = conn.prepareStatement("UPDATE labprocedure SET Status = ?, UpdatedDate = ? WHERE LaboratoryProcedureID=?");
			)
		{
	...
	public List<LabProcedureBean> getAllLabProceduresLOINC(long id) throws DBException {
		...
		try(Connection conn = factory.getConnection();
				PreparedStatement ps = conn.prepareStatement("SELECT * FROM labprocedure WHERE PatientMID = ? ORDER BY LaboratoryProcedureCode ASC");
			)
		{
			if (id == 0L) throw new SQLException("PatientMID cannot be null");		
			ps.setLong(1, id);
