...
public class RecordsReleaseDAO {
	...
	public boolean addRecordsRelease(RecordsReleaseBean bean) throws DBException {
		...
		try (
				...
				PreparedStatement ps = conn.prepareStatement("INSERT INTO recordsrelease(requestDate,pid,releaseHospitalID,recHospitalName,"
	...
	public boolean updateRecordsRelease(RecordsReleaseBean bean) throws DBException {
		...
		try (
				Connection conn = factory.getConnection();
				PreparedStatement ps = conn.prepareStatement("UPDATE recordsrelease SET requestDate=?, pid=?, releaseHospitalID=?, "
	...
	public List<RecordsReleaseBean> getAllRecordsReleasesByHospital(String hospitalID) throws DBException {
		...
		try (
				Connection conn = factory.getConnection();
				PreparedStatement ps = conn.prepareStatement("SELECT * FROM recordsrelease "
