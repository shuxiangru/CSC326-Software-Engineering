...
public class TelemonitoringUseCaseTest extends iTrustSeleniumTest {
	...
	public void testAddPatientsToMonitor() throws Exception {		
		...
		driver.findElement(By.xpath("//h2[text()=\"Telemedicine\"]")).click();
	...
	public void testUAPAddHCPMonitor() throws Exception{
		...
		HCPdriver.findElement(By.xpath("//h2[text()=\"Telemedicine\"]")).click();
	...
	public void testDetailedExternalData() throws Exception {
		...
		driver.findElement(By.name("submitRecord")).submit();
		
		for (int second = 0;; second++) {
			if (second >= 60)
				fail("timeout");
			try {
				System.out.println(driver.findElement(By.xpath("//*[@id='iTrustContent']/table[1]/tbody/tr[1]/th")).getText());
				if ("Patient Details".equals(
						driver.findElement(By.xpath("//*[@id='iTrustContent']/table[1]/tbody/tr[1]/th")).getText()))
					break;
			} catch (Exception e) {
