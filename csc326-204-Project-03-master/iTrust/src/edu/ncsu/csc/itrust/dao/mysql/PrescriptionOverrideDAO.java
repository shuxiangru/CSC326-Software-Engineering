...
public class PrescriptionOverrideDAO {
	...
	public List<OverrideReasonBean> getList(long medID) throws DBException {
		try (	Connection conn = factory.getConnection();
				PreparedStatement ps = conn.prepareStatement("Select * From ovreactionoverride Where ovmedicationID = ? ");
				) {
	...
	public long add(OverrideReasonBean pres) throws DBException {
		try (
				...
				PreparedStatement ps = conn.prepareStatement("INSERT INTO ovreactionoverride (OVMedicationID,OverrideCode) VALUES (?,?)");
			){
	...
	public void remove(long ovMedicationID) throws DBException {
		try (
				Connection conn = factory.getConnection();
				PreparedStatement ps = conn.prepareStatement("DELETE FROM ovreactionoverride WHERE OVMedicationID=? ");
			){
