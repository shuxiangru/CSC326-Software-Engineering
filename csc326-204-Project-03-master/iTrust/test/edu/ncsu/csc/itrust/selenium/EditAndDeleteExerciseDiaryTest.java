...
/**
 * Tests that patients can edit and delete entries in their exercise diary.
 */
public class EditAndDeleteExerciseDiaryTest extends iTrustSeleniumTest {
	...
	/**
	 * Tests that a Patient cannot enter invalid values when editing a Exercise
	 * Diary entry.
	 */
	...
	/**
	 * Tests that a user cannot enter an invalid date when editing a exercise
	 * diary entry.
	 */
