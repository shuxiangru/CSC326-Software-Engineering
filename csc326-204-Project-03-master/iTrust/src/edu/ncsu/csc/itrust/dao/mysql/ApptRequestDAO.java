...
public class ApptRequestDAO {
	...
	public List<ApptRequestBean> getApptRequestsFor(final long hcpid) throws SQLException, DBException {
		try (Connection conn = factory.getConnection();
				PreparedStatement stmt = conn.prepareStatement("SELECT * FROM appointmentrequests WHERE doctor_id=? ORDER BY sched_date");
					) {
	...
	public List<ApptRequestBean> getApptRequestsForPatient(final long patientid) throws SQLException, DBException {
