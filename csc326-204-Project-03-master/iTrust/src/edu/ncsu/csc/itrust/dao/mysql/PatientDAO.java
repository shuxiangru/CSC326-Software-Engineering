...
public class PatientDAO {
	...
	public void editPatient(PatientBean p, long hcpid) throws DBException {
		...
		try (Connection conn = factory.getConnection();
				PreparedStatement ps = conn.prepareStatement("UPDATE patients SET firstName=?,lastName=?,email=?,"
	...
	public void addHistory(long pid, long hcpid) throws DBException {
		...
		try(Connection conn = factory.getConnection();
				PreparedStatement ps = conn.prepareStatement("INSERT INTO historypatients SELECT null, CURDATE(), ?, p.* FROM patients p WHERE p.mid=?");
			)
		{
			ps.setLong(1, hcpid);
			ps.setLong(2, pid);
	...
	public boolean hasHistory(long pid) throws DBException {
		...
		try(Connection conn = factory.getConnection();
				PreparedStatement ps = conn.prepareStatement("SELECT * FROM historypatients WHERE mid=?");
			)
		{
			ps.setLong(1, pid);
			ResultSet rs;
	...
	public List<PersonnelBean> getDeclaredHCPs(long pid) throws DBException {
		try{if (pid == 0L) throw new SQLException("pid cannot be 0");}
		catch(SQLException e) {
	...
	public void removeAllRepresented(long representerMID) throws DBException {
		...
		try (Connection conn = factory.getConnection();
				PreparedStatement ps = conn.prepareStatement("UPDATE users U, representatives R SET U.isDependent=0 WHERE R.representerMID=? AND "
	...
	public void removeAllRepresentee(long representeeMID) throws DBException {
		...
		try (Connection conn = factory.getConnection();
				PreparedStatement ps = conn.prepareStatement("DELETE FROM representatives WHERE representeeMID=?");
				PreparedStatement ps2 = conn.prepareStatement("UPDATE users SET isDependent=0 WHERE MID=?");
			)
		{
	...
	public List<DiagnosisBean> getDiagnoses(long pid) throws DBException {
		...
		try (Connection conn = factory.getConnection();
				PreparedStatement ps = conn.prepareStatement("SELECT * FROM ovdiagnosis ovd, officevisits ov, icdcodes icd "
	...
	public List<ProcedureBean> getProcedures(long pid) throws DBException {
		...
		try(Connection conn = factory.getConnection();
				PreparedStatement ps = conn.prepareStatement("Select * From ovprocedure ovp, officevisits ov, cptcodes cpt "
	...
	public List<PrescriptionBean> getPrescriptions(long patientID) throws DBException {
		try (Connection conn = factory.getConnection();
				PreparedStatement ps = conn.prepareStatement("Select * From ovmedication,ndcodes,officevisits "
	...
	public List<PrescriptionBean> getExpiredPrescriptions (long patientID) throws DBException {
		try{if (patientID == 0L) throw new SQLException("pid cannot be 0");}
		catch(SQLException e) {
	...
	public long getDesignatedNutritionist(long patientMID) 
		...
		try (Connection conn = factory.getConnection();
				PreparedStatement ps = conn.prepareStatement("SELECT HCPID FROM "
	...
	public int updateDesignatedNutritionist(long patientMID, long HCPID) 
		...
		try (Connection conn = factory.getConnection();
				PreparedStatement ps = conn.prepareStatement("UPDATE designatedNutritionist "
	...
	public int deleteDesignatedNutritionist(long patientMID) 
		...
		try (Connection conn = factory.getConnection();
				PreparedStatement ps = conn.prepareStatement("DELETE FROM designatedNutritionist "
					+ "WHERE PatientID = ?;");
			)
		{
			ps.setLong(1, patientMID);
	 ...
	 * @throws DBException
	 */
	public List<PatientBean> getDependantPatients(long mid) throws DBException {
		
		try (Connection conn = factory.getConnection();
				PreparedStatement ps = conn.prepareStatement("SELECT patients.* FROM patients,users WHERE (patients.MotherMID = ? OR patients.FatherMID = ?) AND patients.MID = users.MID AND users.isDependent=1");
			)
		{
			ps.setLong(1, mid);
			ps.setLong(2, mid);
			ResultSet rs = ps.executeQuery();
			List<PatientBean> pat = patientLoader.loadList(rs);
			rs.close();
