...
%>
	...
	<table style="width:100%;" id="sampleLoginTable">
		...
		<tr>
			<td>
				<a class="iTrustTestNavlink" onclick="fillLoginFields('9900000002','pw')" href="javascript:void(0)">HCP13</a>
			</td>
		</tr>
		<tr>
			<td>
				<a class="iTrustTestNavlink" onclick="fillLoginFields('9900000003','pw')" href="javascript:void(0)">HCP14</a>
			</td>
		</tr>
	</table>
	</div>
