...
CREATE TABLE surgicalorthopedicvisits (
	SurgicalOrthopedicVisitID	BIGINT unsigned AUTO_INCREMENT,
	OrthopedicID				BIGINT unsigned NOT NULL,
	OrthopedicVisitID	    	BIGINT unsigned NOT NULL,
	PID							BIGINT unsigned NOT NULL,
	SurgicalOrthopedicVisitDate DATE NOT NULL,
	TotalKneeReplacement		BOOLEAN default FALSE,
	TotalJointReplacement		BOOLEAN default FALSE,
	ACLReconstruction			BOOLEAN default FALSE,
	AnkleReplacement			BOOLEAN default FALSE,
	SpineSurgery				BOOLEAN default FALSE,
	ArthroscopicSurgery			BOOLEAN default FALSE,
	RotatorCuffRepair			BOOLEAN default FALSE,
	SurgeryNotes				VARCHAR(200) DEFAULT '',
	AddedVisit					BOOLEAN default FALSE,
	
	PRIMARY KEY(SurgicalOrthopedicVisitID)
) ENGINE=MyISAM;

CREATE TABLE physicaltherapyvisits(
	PhysicalTherapyVisitID	BIGINT unsigned AUTO_INCREMENT,
	OrthopedicVisitID	    BIGINT unsigned NOT NULL,
	PhysicalTherapistID		BIGINT unsigned NOT NULL,
	PID						BIGINT unsigned NOT NULL,
	PhysicalTherapyVisitDate		DATE NOT NULL,
	HouseWorkScore			TINYINT NOT NULL,
	BathScore				TINYINT NOT NULL,
	WalkingRoomScore		TINYINT NOT NULL,
	SquatScore				TINYINT NOT NULL,
	LiftScore				TINYINT NOT NULL,
	WalkingBlockScore		TINYINT NOT NULL,
	StairsScore				TINYINT NOT NULL,
	StandingScore			TINYINT NOT NULL,
	JumpingScore			TINYINT NOT NULL,
	RunningScore			TINYINT NOT NULL,
	QuadSetExercise			BOOLEAN default NULL,
	HeelSlideExercise		BOOLEAN default NULL,
	CalfTowelExercise		BOOLEAN default NULL,
	StraightLegExercise		BOOLEAN default NULL,
	TerminalKneeExercise	BOOLEAN default NULL,
	GastrocStretchExercise	BOOLEAN default NULL,
	WallSlideExercise		BOOLEAN default NULL,
	ProprioceptionExercise	BOOLEAN default NULL,
	HipAbductionExercise	BOOLEAN default NULL,
	SingleLegExercise		BOOLEAN default NULL,
	AddedVisit				BOOLEAN default FALSE,
	
	PRIMARY KEY (PhysicalTherapyVisitID)
) ENGINE=MyISAM;

CREATE TABLE orthopedicvisits(
	OrthopedicVisitID		BIGINT unsigned NOT NULL AUTO_INCREMENT,
	OrthopedicID		BIGINT unsigned NOT NULL,
	PID                 BIGINT unsigned NOT NULL,
	OrthopedicVisitDate	DATE NOT NULL,
	InjuredPart			VARCHAR(50) default NULL,
	XRay				longblob default NULL,
	MRI					longblob default NULL,
	MRIReport			VARCHAR(200) default NULL,
	ACLInjury			TINYINT NOT NULL,
	MeniscusTear		TINYINT NOT NULL,
	RAHand				TINYINT NOT NULL,
	Chondromalacia		TINYINT NOT NULL,
	CPC					TINYINT NOT NULL,
	WhiplashInjury		TINYINT NOT NULL,
	
	PRIMARY KEY (OrthopedicVisitID)
	/* Please use the MyISAM backend with no foreign keys.*/
) ENGINE=MyISAM;
