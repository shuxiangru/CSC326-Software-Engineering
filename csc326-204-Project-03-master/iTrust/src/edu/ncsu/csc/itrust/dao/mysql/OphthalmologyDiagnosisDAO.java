...
public class OphthalmologyDiagnosisDAO {
	...
	public List<OphthalmologyDiagnosisBean> getList(long visitID) throws DBException {
		...
		try (Connection conn = factory.getConnection();
				PreparedStatement ps = conn.prepareStatement("Select * From icdcodes,opdiagnosis Where opdiagnosis.VisitID = ? "
	...
	public void remove(long ovDiagnosisID) throws DBException {
		...
		try (Connection conn = factory.getConnection();
				PreparedStatement ps = conn.prepareStatement("DELETE FROM opdiagnosis WHERE ID=? ");
			)
		{
	...
	public List<OphthalmologyDiagnosisBean> getOpICDCodes() throws DBException {
		...
		try (Connection conn = factory.getConnection();
				PreparedStatement ps = conn.prepareStatement("SELECT * FROM icdcodes where Ophthalmology='yes' ORDER BY CODE");
			)
		{
			ResultSet rs = ps.executeQuery();
