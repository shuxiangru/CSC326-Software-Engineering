...
<%
	...
	loggingAction.logEvent(TransactionType.VIEW_PHYSICAL_THERAPY_OV, loggedInMID.longValue(), Long.parseLong((String) session.getAttribute("pid")), Long.toString(bean.getPhysicalTherapyVisitID()));
%>
