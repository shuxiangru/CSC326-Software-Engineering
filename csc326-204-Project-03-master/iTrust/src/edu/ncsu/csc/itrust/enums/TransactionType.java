...
public enum TransactionType {
	...
	/**CREATE_ORTHOPEDIC_OV**/
	CREATE_ORTHOPEDIC_OV(8800, "Create orthopedic Office Visit", "UC88 Create", true),
	/**VIEW_ORTHOPEDIC_OV**/
	VIEW_ORTHOPEDIC_OV(8801, "View orthopedic Office Visit", "UC88 View", true),
	/**EDIT_ORTHOPEDIC_OV**/
	EDIT_ORTHOPEDIC_OV(8802, "Edit orthopedic Office Visit", "UC88 Edit", true),
	
	/**CREATE_PHYSICAL_THERAPY_OV**/
	CREATE_PHYSICAL_THERAPY_OV(8900, "Create physical therapy Office Visit", "UC89 Create", true),
	/**VIEW_PHYSICAL_THERAPY_OV**/
	VIEW_PHYSICAL_THERAPY_OV(8901, "View physical therapy Office Visit", "UC89 View", true),
	/**EDIT_PHYSICAL_THERAPY_OV**/
	EDIT_PHYSICAL_THERAPY_OV(8902, "Edit physical therapy Office Visit", "UC89 Edit", true),
	
	/**CREATE_SURGICAL_OPHTHALMOLOGY_OV**/
	CREATE_SURGICAL_OPHTHALMOLOGY_OV(9000, "Create Surgical Ophthalmology Office Visit", "UC90 Create", true),
	/**VIEW_SURGICAL_OPHTHALMOLOGY_OV**/
	VIEW_SURGICAL_OPHTHALMOLOGY_OV(9001, "View Surgical Ophthalmology Office Visit", "UC90 View", true),
	/**EDIT_SURGICAL_OPHTHALMOLOGY_OV**/
	EDIT_SURGICAL_OPHTHALMOLOGY_OV(9002, "Edit Surgical Ophthalmology Office Visit", "UC90 Edit", true),
	
	/**PATIENT_VIEW_ORTHOPEDIC_PT_OV**/
	PATIENT_VIEW_ORTHOPEDIC_PT_OV(9100, "View Patient Orthopedic/PT Office Visit", "UC91 View", true),
	/**PATIENT_VIEW_DEPENDANT_ORTHOPEDIC_PT_OV**/
	PATIENT_VIEW_DEPENDANT_ORTHOPEDIC_PT_OV(9101, "View Dependent Orthopedic/PT Office Visit", "UC91 View", true),

	/**PATIENT_VIEW_APPPOINTMENT_REQUESTS**/
	PATIENT_VIEW_APPPOINTMENT_REQUESTS(9200, "View Appointment Requests", "UC92 View", true)
	;
	/**
