...
public class DesignateAndViewHCPUseCaseTest extends iTrustSeleniumTest {
	...
	public void testReportSeenHCPs0() throws Exception {
		...
		driver.findElement(By.xpath("//h2[text()='View']")).click();
	...
	public void testReportSeenHCPs1() throws Exception {
		...
		assertEquals("iTrust - My Providers", driver.getTitle());		
		WebElement removeID;
		((JavascriptExecutor) driver).executeScript("arguments[0].click();", removeID = driver.findElement(By.name("removeID")));
		removeID.clear();
		((JavascriptExecutor) driver).executeScript("document.getElementById('removeID').setAttribute('value', 'Jason Frakenstein')");
